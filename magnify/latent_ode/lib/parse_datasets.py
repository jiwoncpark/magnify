...
from generate_timeseries import Periodic_1d, Periodic1dDataset
...
def parse_datasets(args, device):
    ...
    if dataset_name == "hopper":
        ...
        input_dim = train_y.size(-1)  # which-dimensional time series?
    ...
    if dataset_name == "physionet":
        ...
        if not args.classif:
            ...
            # Therefore, if we do classification task, we don't need physionet 'test' samples.
